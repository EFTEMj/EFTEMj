...
/**
 * The GenericDialogPlus class enhances the GenericDialog by a few additional methods.
 *
 * It adds a method to add a file chooser, a dialog chooser, an image chooser, a button, and makes string (and file)
 * fields drop targets.
 */
public class GenericDialogPlus extends GenericDialog {
     ...
     *
     * @param path
     *            - the path to the image in the jar, e.g. /images/fiji.png (the first / has to be there!)
     ...
     *
     *         image.setImage(otherImageIcon.getImage()); label.update(label.getGraphics());
     */
