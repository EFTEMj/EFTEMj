...
/**
 * An example fit which fits a straight line to some data points and prints out
...
public class ExampleFit {
	...
	LMA lma = new LMA(new ExampleFunction(), new double[] { 1, 1 },
		new double[][] { { 0, 2, 6, 8, 9 }, { 5, 10, 23, 33, 40 } });
	lma.fit();
	System.out.println("iterations: " + lma.iterationCount);
	System.out.println("chi2: " + lma.chi2 + ", param0: "
		+ lma.parameters[0] + ", param1: " + lma.parameters[1]);
    }
}
